...
MaHanya is priority-aware intelligent traffic control: SUMO simulation + a
...
- **`api/`** is Python: SUMO/TraCI simulation, the transformer model, the
  ...
  own `pyproject.toml`.
- **`web/`** is a Next.js SPA static export, built exclusively from Shadcn UI
